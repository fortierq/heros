...
export const foretSombre: Adventure = {
  ...
  coverImage: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=800&h=500&fit=crop',
  theme: 'fantasy',
  themeColors: {
    primary: '#1a472a',
    secondary: '#2d5a3f',
  ...
  allItems: {
    ...
    amulette_loup: {
      ...
      description: 'Un pendentif gravé d\'un loup hurlant. Augmente l\'attaque.',
      icon: '🐺',
      type: 'ring',
    ...
    epee_flamme: {
      id: 'epee_flamme',
      name: 'Épée de Flamme',
      description: 'Une lame enchantée qui brûle d\'un feu éternel.',
      icon: '🔥',
      type: 'weapon',
    ...
    bouclier_ancien: {
      ...
      description: 'Un bouclier ouvragé trouvé dans les ruines.',
      icon: '🛡️',
      type: 'armor',
    ...
    couronne_roi: {
      ...
      description: 'La couronne d\'un roi dont le nom s\'est perdu dans le temps.',
      icon: '👑',
      type: 'quest',
    },
  },
  ...
  scenes: {
    ...
    entree_foret: {
      ...
      image: 'https://images.unsplash.com/photo-1476231682828-37e571bc172f?w=800&h=400&fit=crop',
    ...
    puits_profondeur: {
      ...
      image: 'https://images.unsplash.com/photo-1504700610630-ac6aba3536d3?w=800&h=400&fit=crop',
    ...
    victoire_araignee: {
      ...
      image: 'https://images.unsplash.com/photo-1514539079130-25950c84af65?w=800&h=400&fit=crop',
    ...
    ruines_nord: {
      ...
      image: 'https://images.unsplash.com/photo-1518709766631-a6a7f45921c3?w=800&h=400&fit=crop',
    ...
    entree_principale_donjon: {
      ...
      image: 'https://images.unsplash.com/photo-1551524559-8af4e6624178?w=800&h=400&fit=crop',
    ...
    entree_service_donjon: {
      ...
      image: 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=800&h=400&fit=crop',
