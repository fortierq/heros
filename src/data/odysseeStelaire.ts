...
export const odysseeStelaire: Adventure = {
  ...
  coverImage: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=800&h=500&fit=crop',
  theme: 'scifi',
  themeColors: {
    primary: '#1a1a4e',
    secondary: '#2d2d7b',
  ...
  startingItems: [
    {
      ...
      description: 'Un blaster de série, fiable mais peu puissant.',
      icon: '🔫',
      type: 'weapon',
    },
    {
  ...
  allItems: {
    blaster_standard: {
      id: 'blaster_standard',
      name: 'Blaster Standard',
      description: 'Un blaster de série.',
      icon: '🔫',
      type: 'weapon',
    },
    medikit: {
    ...
    blaster_plasma: {
      ...
      description: 'Arme de haute technologie alien.',
      icon: '⚡',
      type: 'weapon',
    ...
    armure_nano: {
      ...
      description: 'Armure utilisant la nanotechnologie.',
      icon: '🦾',
      type: 'armor',
  ...
  scenes: {
    ...
    jungle_cristal: {
      ...
      image: 'https://images.unsplash.com/photo-1534996858221-380b92700493?w=800&h=400&fit=crop',
