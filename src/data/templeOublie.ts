...
export const templeOublie: Adventure = {
  ...
  startingItems: [
    {
      ...
      description: "Une lance forgée à Athènes. Dégâts : 5.",
      icon: "🔱",
      type: "weapon",
      damage: 5,
    },
  ...
  allItems: {
    ...
    bouclier_athena: {
      id: "bouclier_athena",
      name: "Égide d'Athéna",
      description: "Le bouclier légendaire orné de la Gorgone. Défense +12.",
      icon: "🛡️",
      type: "armor",
    ...
    epee_styx: {
      id: "epee_styx",
      name: "Épée du Styx",
      description: "Forgée dans les eaux du fleuve des Enfers. Dégâts : 18.",
      icon: "⚔️",
      type: "weapon",
      damage: 18,
    ...
    pomme_or: {
      ...
      effects: [
        { type: "heal", value: 80 },
        { type: "stat_boost", target: "maxHp", value: 20 },
      ],
    },
    couronne_laurier: {
      id: "couronne_laurier",
  ...
  scenes: {
    ...
    centre_labyrinthe: {
      ...
      combat: {
        ...
        enemyDefense: 13,
        enemySpells: [
          { name: "Charge Furieuse", icon: "🐂", damage: 20, chance: 0.3 },
        ],
    ...
    combat_cerbere: {
      ...
      combat: {
        ...
        enemyDefense: 15,
        enemySpells: [
          { name: "Triple Morsure", icon: "🐺", damage: 24, chance: 0.35 },
          { name: "Souffle Infernal", icon: "🔥", damage: 18, chance: 0.2 },
        ],
    ...
    combat_cronos_faible: {
      ...
      combat: {
        ...
        enemySpells: [
          ...
          { name: "Vague du Temps", icon: "🌊", damage: 20, chance: 0.2 },
        ],
    ...
    combat_cronos_fort: {
      ...
      combat: {
        ...
        enemySpells: [
          ...
          { name: "Vague du Temps", icon: "🌊", damage: 25, chance: 0.25 },
          { name: "Chronorégénération", icon: "♻️", healing: 35, chance: 0.15 },
        ],
        victoryScene: "victoire_cronos",
        defeatScene: "defaite_mythologique",
        xpReward: 250,
