    ...
    <div className="min-h-screen bg-pattern-dots">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 md:py-32 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-8 font-body">
            Plongez dans des mondes extraordinaires où chaque choix façonne
            votre destin. Combattez des créatures légendaires, récoltez des
            objets magiques et montez de niveau au fil d'aventures palpitantes.
          </p>
      ...
      <main className="max-w-6xl mx-auto px-6 pb-20">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="font-medieval text-2xl text-parchment">
